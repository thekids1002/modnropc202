...
/*		mFont.tahoma_7_yellow.drawString(g, "num      " + num/1000, 80, 100, 0);
		mFont.tahoma_7_yellow.drawString(g, "num2         " + num2/1000, 80, 110, 0);
		mFont.tahoma_7_yellow.drawString(g, "coolDown            " + coolDown, 80, 120, 0);*/
		if (num2 < coolDown)
		{
